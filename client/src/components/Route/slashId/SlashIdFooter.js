...
const SlashIdFooter = (props) => {
  ...
  return (
    <>
      <div
        className="app-pd-l-2 app-pd-r-2 app-pd-b-1 app-pd-t-1 app-body-right-background"
      >
      ...
      <div className="app-flex app-justify-content-center app-align-items-center app-pd-l-2 app-pd-r-2 app-body-right-background">
        <div className="card__display__flex__wrap">
          {props.streams.length !== 0 ? props.streams.map((e, i) => {
            return (
                        ...
                        <div className="app__flex__nowrap app__flex">
                          ...
                          {/* <div className="channel__icon">
                                    <Link
                                        ...
                                        <img className="channel__icon__1" src={props.location.state.data.profile_image_url}/>
                                    </Link>
                                </div> */}
                        ...
                        <div className="app__relative app__cursor">
                          ...
                          <div className="app__absolute app__top__0 app__left__0 app__card__height app__width">
                            <div className="app__absolute app__bottom__0 app__right__0 app__margin ">
                              <p
                                className="app-archive-indicator app__padding app__margin__bottom app__border__radius"
