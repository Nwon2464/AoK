    ...
    <div className="game__card app-pd-15">
      <div className="card__maxWidth__margin app__tower__gutter">
        <h3 style={{ paddingBottom: "0.5rem", paddingLeft: "0.2rem" }}>
          <Skeleton height={28} width={250} style={{ backgroundImage: "none", backgroundColor: "var(--theme-control)" }} />
        </h3>
                        ...
                        <article className="card__display__flex__direction">
                            ...
                            <div className="app__flex__nowrap app__flex">
                                ...
                                <div className="app__margin__bottom">
                                  <div className="channel__font_1">
                                    <h3 className="app__ellipsis app__font__weight">
                                      <Skeleton width="227px" style={{ backgroundImage: "none", backgroundColor: "var(--theme-control)" }} />
                                    </h3>
                                  </div>
                                </div>
                                <div className="channel__user">
                                  <div>
                                    <h4 className="app__ellipsis app__font__size__0_8 app__color__grey app__cursor">
                                      <Skeleton width="150px" style={{ backgroundImage: "none", backgroundColor: "var(--theme-control)" }} />
                                    </h4>
                                  </div>
                                  <div>
                                    <h5 className="app__ellipsis app__font__size__0_8">
                                      <Skeleton width="180px" style={{ backgroundImage: "none", backgroundColor: "var(--theme-control)" }} />
                                    </h5>
                                  </div>
                                </div>
                                  ...
                                  <div className="channel__tag__1">
                                    <div className="channel__tag__2">
                                      <div className="channel__tag__3">
                                        <Skeleton width="230px" style={{ backgroundImage: "none", backgroundColor: "var(--theme-control)" }} />
                                      </div>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div className="channel__icon">
                                <Skeleton
                                  circle={true}
                                  height={40}
                                  width={40} style={{ backgroundImage: "none", backgroundColor: "var(--theme-control)" }}
                                />
                              </div>
                              <div className="channel__down">
                                <Skeleton
                                  circle={true}
                                  height={30}
                                  width={20} style={{ backgroundImage: "none", backgroundColor: "var(--theme-control)" }}
                                />
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="app__order__1">
                            <div className="app__relative app__cursor">
                              <Skeleton width="290px" height="170px" style={{ backgroundImage: "none", backgroundColor: "var(--theme-control)" }} />
                            </div>
                          </div>
                        </article>
                      </div>
